...
from aiohttp_admin_site.mappers.generics import MongoMapperGeneric
from aiohttp_admin_site.resources.mongo_resource.mongo_resource import MongoResource  # noqa
