...
coverage: ## check code coverage quickly with the default Python
	coverage run --source aiohttp_admin_site setup.py test
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/aiohttp_admin_site.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ aiohttp_admin_site
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
lint: bandit  ## check style
	flake8 aiohttp_admin_site --exclude views/aiohttp/templates
